...
import Level1Agent from "@/components/example/level-1";
import { ConfigResource, defaultConfig } from "@/lib/config";
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            A 4-level deep component hierarchy demonstrating Scarcity&apos;s
            powerful context switching capabilities. Watch how configs flow and
            transform through the component tree.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-6 text-gray-300">
              <div className="bg-scarcity-dark-lighter/50 p-4 rounded-lg border-l-4 border-red-500">
                ...
                <p>
                  The top-level component that starts the hierarchy and passes
                  the original config down.
                </p>
              </div>
              ...
              <div className="bg-scarcity-dark-lighter/50 p-4 rounded-lg border-l-4 border-green-500">
                ...
                <p>
                  <strong>⭐ The Magic Happens Here!</strong> Level 2 displays
                  the original config AND creates a modified version that it
                  supplies to Level 3 & 4 using{" "}
              ...
              <div className="bg-scarcity-dark-lighter/50 p-4 rounded-lg border-l-4 border-blue-500">
                ...
                <p>
                  Receives the modified config from Level 2 and passes it to
                  Level 4.
                </p>
              </div>
              ...
              <div className="bg-scarcity-dark-lighter/50 p-4 rounded-lg border-l-4 border-purple-500">
                ...
                <p>
                  Displays the final modified config - completely different from
                  what Level 2 originally received!
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-scarcity-orange/10 to-scarcity-red/10 border border-scarcity-orange/30 rounded-lg">
              ...
              <p className="text-gray-300 text-sm">
                Notice how Level 2 shows the original blue theme, but Level 4
                shows a completely different emerald theme! This demonstrates
                Scarcity&apos;s powerful context switching - the same component
                tree can work with different configurations at different levels.
              </p>
            </div>
          </div>
    ...
    // ... render logic
        ...
        <div className="mt-16 text-center">
          <h2 className="text-3xl font-bold mb-8">
            <span className="gradient-scarcity-text">Why This Matters</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-scarcity-dark-lighter/50 p-6 rounded-lg border border-scarcity-gray/30">
              ...
              <p className="text-gray-300">
                Easily inject mock configurations for different test scenarios
            ...
            <div className="bg-scarcity-dark-lighter/50 p-6 rounded-lg border border-scarcity-gray/30">
              ...
              <p className="text-gray-300">
                Switch between development, staging, and production configs
            ...
            <div className="bg-scarcity-dark-lighter/50 p-6 rounded-lg border border-scarcity-gray/30">
              ...
              <p className="text-gray-300">
                Override dependencies at any level of your component tree
                without affecting parent components.
              </p>
            </div>
          </div>
        </div>
