            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
                    ...
                    <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Powerful, type-inferred, and hyper-minimalistic library
                        for server request propagation and dependency injection
                        using a novel{" "}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        <div className="bg-scarcity-dark-lighter/50 backdrop-blur-sm p-6 rounded-lg border border-scarcity-gray/30">
                            ...
                            <p className="text-gray-400 text-sm">
                                Pure functions and objects with compile-time
                                optimization
                            </p>
                        </div>
                        ...
                        <div className="bg-scarcity-dark-lighter/50 backdrop-blur-sm p-6 rounded-lg border border-scarcity-gray/30">
                            ...
                            <p className="text-gray-400 text-sm">
                                Full TypeScript inference throughout the
                                dependency chain
                            </p>
                        </div>
                        ...
                        <div className="bg-scarcity-dark-lighter/50 backdrop-blur-sm p-6 rounded-lg border border-scarcity-gray/30">
                            ...
                            <p className="text-gray-400 text-sm">
                                Powerful resupply() for dynamic dependency
                                injection
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-20 px-6">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                        Check out our interactive example with 4-level deep
                        component hierarchy demonstrating context switching and
                        dependency injection.
                    </p>
